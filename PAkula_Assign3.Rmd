...
**_Characteristic polynomial equation for given matrix is $`r cp[4]`x^3 + `r cp[3]`x^2 `r cp[2]`x + `r cp[1]`$_**
...
**_By setting the characteristic polynomial equation equal to zero, $p_{A}(x) = `r cp[4]`x^3 + `r cp[3]`x^2 `r cp[2]`x + `r cp[1]` = 0$_**
